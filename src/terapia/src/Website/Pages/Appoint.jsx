...
function Appoint() {
    return (
        <div>
            <Header />
            <Navs title="Book Appointment" desc="Appointment" />
            <div>
                                    ...
                                    <div className="row g-4">
                                        <div className="col-sm-6">
                                            <div className="d-flex flex-column h-100">
                                                <div className="mb-4">
                                                    <h5 className="mb-3"><i className="fa fa-check text-primary me-2" /> Body Relaxation</h5>
                                    ...
                                    <form>
                                        <div className="row gy-3 gx-4">
                                            ...
                                            <div className="col-12">
                                                <textarea className="form-control border-primary bg-transparent text-white" name="text" id="area-text" cols={30} rows={5} placeholder="Write Comments" defaultValue={""} />
                                            </div>
                                            <div className="col-12">
