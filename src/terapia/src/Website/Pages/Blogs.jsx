...
function Blogs() {
  return (
    <div>
        <Header />
        <Navs title="Physiotherapy Blog" desc="Blog" />
      {/* Blog Start */}
        ...
        <div className="blog-item rounded">
          ...
          <div className="blog-centent p-4">
            <div className="d-flex justify-content-between mb-4">
              <p className="mb-0 text-muted"><i className="fa fa-calendar-alt text-primary" /> 01 Jan 2045</p>
              <a href="#" className="text-muted"><span className="fa fa-comments text-primary" /> 3 Comments</a>
            </div>
            <a href="#" className="h4">Remove back pain while working on a physio</a>
